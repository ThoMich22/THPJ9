...
puts "Dans cet array, il  y a #{tab.length} handle"
...
puts "Dans cet array, le handle le plus court est #{tab.min { |a, b| a.length <=> b.length }}" 

puts " " 
puts " " 
puts " " 
#Combien y-a-t'il de handle contenant 5 caractères (le @ ne compte pas pour un caractère)
puts "Dans cet array, il y a #{tab.count { |c| c.length == 6 }} handle contenant 5 caractères"

puts " " 
puts " " 
puts " " 
#Combien commencent par une majuscule (première lettre juste après le @) ?
puts "Dans cet array, il y a #{tab.count { |d| d[1] =~ /[[:upper:]]/ }} handle commençant par une majuscule"

puts " " 
puts " " 
puts " " 
#Trie la liste de handle par ordre alphabétique.
print "Voici la liste de handle par ordre alphabétique :"
puts "#{tab.sort}"
...
print "Voici la liste de handle par taille :"
puts "#{tab.sort {|e, f| e.length <=> f.length}}"
